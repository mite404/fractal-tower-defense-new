...
import { findValidPath } from "./validPath.ts";
...
console.log(
	`Testing on entrance: ${JSON.stringify(entrance)}, exit: ${JSON.stringify(
		exit
	)}`
);
...
findValidPath(testGrid1, entrance, exit);
...
findValidPath(testGrid2, entrance, exit);
...
findValidPath(testGrid3, entrance, exit);
...
findValidPath(testGrid4, entrance, exit);
...
findValidPath(testGrid5, entrance, exit);
...
findValidPath(testGrid6, entrance, exit);
